import { _replaceAdjacentItems } from './index';
...
if (arraysMatch(arr,  [ 50, 'x', 'y', 'z', 'a', 'b', 3, 4, 5, 6, 7, 8, 9 ]))
...
if (arraysMatch(arr, [ 50, 'x', 'y', 'z', 'a', 'b', 3, 4, 5, 'x', 'y', 'z', 9 ]))
...
if (arraysMatch(arr, [ 50, 'x', 'y', 'z', 'a', 'b', 3, [ 1 ], 'z', 9 ]))
